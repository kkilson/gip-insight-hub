...
export function ExpensesTab() {
  ...
  const bulk = useBulkSelection(expenses);
    ...
    <div className="space-y-4">
      ...
      <BulkActionsBar
        ...
        actions={[{
          ...
          confirmTitle: '¿Eliminar egresos seleccionados?',
          onClick: () => { bulk.selectedIds.forEach(id => deleteExpense.mutate(id)); bulk.clearSelection(); },
        }]}
      />
      ...
      <Dialog open={formOpen} onOpenChange={setFormOpen}>
        <DialogContent>
          ...
          <DialogFooter>
            ...
            <Button onClick={handleSave} disabled={saveExpense.isPending || !form.description || !form.expense_date}>{saveExpense.isPending ? 'Guardando...' : 'Guardar'}</Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
